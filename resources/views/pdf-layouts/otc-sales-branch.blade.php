...
use App\Branch;
	...
	$transactions = OTCTransaction::whereBetween('created_at', [$date . ' 00:00:00', $date . ' 23:59:59'])
...
<html>
	...
	<body>
		<p style="text-align: center;">
	        ...
	        <br>
	        <strong>Over-the-counter<br>SALES REPORT<br>as of {{$date}}<br>{{$branch->branch_name}}</strong>
	    </p>
