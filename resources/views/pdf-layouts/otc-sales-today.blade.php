...
use App\OTCTransaction;
	...
	$transactions = OTCTransaction::whereBetween('created_at', [$today . ' 00:00:00', $today . ' 23:59:59'])
...
<html>
	<head>
		<title>Over-the-counter Sales Report - {{$today}} | Maria Jose Salon</title>
	...
	<body>
		<p style="text-align: center;">
	        ...
	        <br>
	        <strong>Over-the-counter<br>SALES REPORT<br>as of {{$today}}<br>{{Auth::user()->branch->branch_name}}</strong>
	    </p>
